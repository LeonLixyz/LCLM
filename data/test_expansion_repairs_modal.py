...
def test():
    ...
    files = ['test_grounding_decision_replay.py', 'test_grounding_subset_accounting.py', 'test_question_grounding_structured.py', 'test_question_grounding_review.py', 'test_accounting_answer_review.py', 'test_grounding_full_review_gate.py', 'test_grounding_claim_review.py', 'test_expansion_release_selection.py', 'test_stage3_release_checks.py',
