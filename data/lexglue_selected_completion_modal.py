...
APP_NAME='lclm-selected-lexglue-completion-20260909-v1'
...
def tests():
    import subprocess
    result=subprocess.run(['python','-m','pytest','-q','tests/test_lexglue_selected_completion.py',
...
def finalize_readiness(policy_path:str,policy_sha:str,review_spec:dict,manifest_spec:dict,terminal_spec:dict,
    ...
    ready={'schema':'reviewed-corrected-expansion-ready-v1','status':'complete','chain_policy_sha256':policy_sha,
        ...
        'approved_for_release':False,'config_allowlist':manifest['config_allowlist'],
        'plan_accounting':manifest['plan_accounting'],'diagnostic_canary':manifest['diagnostic_canary']}
